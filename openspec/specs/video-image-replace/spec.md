# video-image-replace Specification

## Purpose
Replace the full video frame with an uploaded static image for one or more time ranges, keeping the original audio and duration intact.
## Requirements
